...
<div id="main-wrapper" class="container-fluid">
 ...
 <!--TOP H1 -->
  <div id="toph1">
    <section id="s1">
      <h1 class="headingsCen">Register Here!!</h1>
      <hr>
      <br>
    </section>
  </div>
...
$token = $_SESSION['token'];?>
        ...
        <div class="form-group">
          ...
          <div class="alert alert-danger" role="alert" id="passError"></div>
        </div>
        ...
        <div class="form-group">
          ...
          <select class="form-control" id="province" name="Province">
            ...
            <option value="Manitoba">Mantitoba</option>
        ...
        <div class="row ">
							<div class="form-group col-sm-4">
								...
								<input type="text" class="form-control" id="zip" placeholder="Enter your postalcode" name="City">
								<!-- <div class="alert alert-danger" role="alert" id="codeerror"></div> -->
								<span class="alert alert-danger" role="alert"  id="zipError" ></span>
							</div>
							<div  class="form-group col-sm-4">
								...
								<!-- <div class="alert alert-danger" role="alert" id="dobError"></div> -->
								<span class="alert alert-danger" role="alert"  id="dobError" ></span>
							</div>
